/**
 * Создаёт расписание в QStash для отправки напоминания «за 10 мин» каждый понедельник в 4:22 по Бали.
...
module.exports = async function handler(req, res) {
  ...
  const cron = "CRON_TZ=Asia/Makassar 22 4 * * 1";
  ...
  try {
    ...
    return res.status(200).json({ ok: true, message: "QStash schedule created. Reminder will run every Monday 4:22 Bali." });
  } catch (e) {
