...
Турнир в **понедельник в 4:32 (Бали, UTC+8)** → напоминание «за 10 мин» в **4:22 Бали**.
...
Расписание в QStash будет вызывать API каждый понедельник в 4:22 по Бали и отправлять сообщения всем подписчикам, даже если приложение закрыто.
...
2. **Create Cronjob:**
   ...
   - Schedule: **Каждый понедельник, 04:22** (часовой пояс **Asia/Makassar**)
