...
Турнир в **понедельник в 4:42 (Бали, UTC+8)** → напоминание «за 10 мин» в **4:32 Бали**.

## Вариант 1: Vercel Cron (встроенный, работает автоматически)

В `vercel.json` уже настроен cron — каждый понедельник в 4:32 по Бали Vercel вызовет API.  
...
Расписание в QStash будет вызывать API каждый понедельник в 4:32 по Бали и отправлять сообщения всем подписчикам, даже если приложение закрыто.
...
2. **Create Cronjob:**
   ...
   - Schedule: **Каждый понедельник, 04:32** (часовой пояс **Asia/Makassar**)
