...
Турнир в **понедельник в 4:04 (Бали, UTC+8)** → напоминание «за 10 мин» в **3:54 Бали** (только понедельник).
...
2. **Create Cronjob** (за 10 мин):
   ...
   - Schedule: **Каждый понедельник, 03:54** (часовой пояс **Asia/Makassar**)
...
После настройки нажмите в приложении «Напомнить за 10 минут» — подписка сохранится. Сообщение придёт в понедельник в 3:54 по Бали (если cron-job.org вызывает URL вовремя).
