...
Турнир в **понедельник в 4:29 (Бали, UTC+8)** → напоминание «за 10 мин» в **4:19 Бали**.
...
Расписание в QStash будет вызывать API каждый понедельник в 4:19 по Бали и отправлять сообщения всем подписчикам, даже если приложение закрыто.
...
2. **Create Cronjob:**
   ...
   - Schedule: **Каждый понедельник, 04:19** (часовой пояс **Asia/Makassar**)
