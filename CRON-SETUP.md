...
Турнир в **понедельник в 4:04 (Бали, UTC+8)** → напоминание «за час» в **3:04 Бали**, «за 10 мин» в **3:54 Бали** (только понедельник).

## ⚠️ Vercel Hobby: Cron не подходит

На бесплатном плане Vercel Cron — **максимум раз в день**. Два напоминания (3:04 и 3:54 Бали) не успеют оба сработать. **Используйте cron-job.org** (ниже).
...
2. **Create Cronjob** #1 (за час):
   ...
   - Schedule: **Каждый понедельник, 03:04** (часовой пояс Asia/Makassar — Бали)
3. **Create Cronjob** #2 (за 10 мин):
   ...
   - Schedule: **Каждый понедельник, 03:54** (часовой пояс Asia/Makassar — Бали)
...
После настройки нажмите в приложении «Напомнить за час» / «Напомнить за 10 минут» — подписка сохранится. Сообщения придут в понедельник в 3:04 и 3:54 по Бали (если cron-job.org вызывает URL вовремя).
