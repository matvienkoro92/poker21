...
Турнир в **понедельник в 3:32 (Бали, UTC+8)** → напоминание «за час» в **2:32 Бали**, «за 10 мин» в **3:22 Бали** (только понедельник).

## ⚠️ Vercel Hobby: Cron не подходит

На бесплатном плане Vercel Cron — **максимум раз в день**. Два напоминания (2:32 и 3:22 Бали) не успеют оба сработать. **Используйте cron-job.org** (ниже).
...
2. **Create Cronjob** #1 (за час):
   ...
   - Schedule: **Каждый понедельник, 02:32** (часовой пояс Asia/Makassar — Бали)
3. **Create Cronjob** #2 (за 10 мин):
   ...
   - Schedule: **Каждый понедельник, 03:22** (часовой пояс Asia/Makassar — Бали)
...
После настройки нажмите в приложении «За час» / «За 10 мин» — подписка сохранится. Сообщения придут в понедельник в 2:32 и 3:22 по Бали (если cron-job.org вызывает URL вовремя).
