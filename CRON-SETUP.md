...
Турнир в **понедельник в 4:58 (Бали, UTC+8)** → напоминание «за час» в **3:58 Бали**, «за 10 мин» в **4:48 Бали** (только понедельник).

## ⚠️ Vercel Hobby: Cron не подходит

На бесплатном плане Vercel Cron — **максимум раз в день**. Два напоминания (3:58 и 4:48 Бали) не успеют оба сработать. **Используйте cron-job.org** (ниже).
...
2. **Create Cronjob #1** (за час):
   ...
   - Schedule: **Каждый понедельник, 03:58** (часовой пояс **Asia/Makassar**)
...
3. **Create Cronjob #2** (за 10 мин):
   ...
   - Schedule: **Каждый понедельник, 04:48** (часовой пояс **Asia/Makassar**)
   - Включите задачу (Enabled)
...
После настройки отметьте в приложении «Напомнить за час» и/или «Напомнить за 10 минут» — подписка сохранится. Сообщения придут в понедельник в 3:58 и 4:48 по Бали (если cron-job.org вызывает URL вовремя).
