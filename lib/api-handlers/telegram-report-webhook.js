...
function schedulePosterUrl(viewMode, dateParts) {
  if (viewMode !== "today") return `${REPORT_FILES_ORIGIN}/assets/schedule/schedule-all.png`;
  const weekdayFiles = {
    понедельник: "monday",
    вторник: "tuesday",
    среда: "wednesday",
  ...
  return `${REPORT_FILES_ORIGIN}/assets/schedule/schedule-${weekdayFiles[weekday] || "all"}.png`;
}
