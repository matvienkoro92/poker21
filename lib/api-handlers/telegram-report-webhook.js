...
function pulseMainKeyboard(binding) {
  ...
  rows.push([{ text: "💰 Баланс", callback_data: "pulse:balance" }]);
...
module.exports = async function handler(req, res) {
  ...
  const pulseMenuCallback = callbackQuery ? String(callbackQuery.data || "").match(/^pulse:(menu|dynamics|players|totals|clubs|schedule|balance)$/) : null;
