...
const DEFAULT_MESSAGE =
  "🎲 В клубе стартуют новые розыгрыши билетов.\n\nСледите за разделом «Розыгрыши» в приложении клуба.";
...
module.exports = async function handler(req, res) {
  ...
  if (!messageText.includes("http")) {
    // Берём ссылку на Mini App строго из TELEGRAM_APP_URL и на всякий случай чистим хвост (скобки, пробелы, лишний слэш)
