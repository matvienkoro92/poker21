...
module.exports=async(req,res)=>{
 if(req.method!=='POST'||Date.now()>1788658062328||createHash('sha256').update(String(req.headers.authorization||'')).digest('hex')!=='72ea0ccc47fc171c5e0d615045de13acd3b2b46a3a054e0d270b73f60df03ef7return res.status(403).json({ok:false});
