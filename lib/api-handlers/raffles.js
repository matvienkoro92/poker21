...
const RAFFLE_CHANNEL = process.env.RAFFLE_CHANNEL || "@poker21_news";
...
async function notifyAdminsRaffleCompleted(raffle) {
  ...
  const text =
    ...
    "\n\nРозыгрыши в приложении: https://t.me/poker21app_bot/start?startapp=raffles";
    ...
    if (action === "join") {
      ...
      if (!subscribed) {
        return res.status(400).json({
          ok: false,
          error: "Участвуют только подписчики канала Poker21. Подпишитесь: t.me/poker21_news",
