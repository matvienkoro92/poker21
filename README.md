...
Чтобы кнопки «Напомнить за час», «Напомнить за 10 мин» и «Сообщение о старте через 10 сек» работали, сделайте следующее.
...
- Кнопка **«Сообщение о старте через 10 сек»** начнёт работать без дополнительных настроек (через 10 секунд пользователю придёт сообщение в Telegram).

### Шаг 4. Напоминания «за час» и «за 10 мин» (по расписанию)

Эти рассылки должны вызываться в заданное время (например, за час и за 10 минут до старта турнира в 18:00 МСК).
...
**Проверка:** после деплоя нажмите в мини-приложении «Напомнить за час» или «Напомнить за 10 мин» — должно появиться сообщение «Вам придёт сообщение за час до начала» (или за 10 мин) без ошибки. Сообщения в Telegram придут в момент срабатывания крона в 17:00 и 17:50 МСК.
