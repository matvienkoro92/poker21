...
Чтобы кнопки «Напомнить за час», «Напомнить за 5 минут» и «Отправить напоминание сейчас» работали, сделайте следующее.
...
### Шаг 4. Напоминания «за час» и «за 5 мин» (по расписанию)

Эти рассылки должны вызываться в заданное время (например, за час и за 5 минут до старта турнира в понедельник в 3:43 по Бали).
...
Турнир в понедельник в 3:43 (Бали) → напоминание «за час» в 2:43 Бали, «за 5 мин» в 3:38 Бали.
...
3. Создайте вторую задачу для «за 5 мин»:
   - URL: `https://ВАШ-ДОМЕН.vercel.app/api/freeroll-reminder-send?when=5min&secret=ВАШ_CRON_SECRET`
...
**Проверка:** после деплоя нажмите в мини-приложении «Напомнить за час» или «Напомнить за 5 минут» — должно появиться сообщение «Вам придёт сообщение за час до начала» (или за 5 мин) без ошибки. Сообщения в Telegram придут в момент срабатывания крона.
