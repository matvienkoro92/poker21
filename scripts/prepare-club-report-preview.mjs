...
const blockedClubIds = new Set(["758417"]); // Dva Tuza is shown in common club statistics but has no automatic club dispatch
...
for (const mapping of latestMappings.values()) {
  ...
  if (blockedClubIds.has(clubId)) continue;
